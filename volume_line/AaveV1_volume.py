...
def AaveV1():    
    input_csv="/mnt/sde1/peilin_defi/defi_1650w/AaveV1_Transaction.csv"
    output_dict="/mnt/sde1/peilin_defi/data/volume_line/dict/timeWithVolume/AaveV1.map"
    ...
    with open(input_csv,'r', encoding="UTF8") as f:
        ...
        for row in reader:
            ...
            if type=="add" or type=="remove":
                ...
                resVolume=TOKEN_PRICE_CENTER.swap(collateralAddress, timestamp_removeHour,amountMinusFees+fees)

            elif type=="flashloan":                
                resVolume=TOKEN_PRICE_CENTER.swap(collateralAddress, timestamp_removeHour,amount+totalFee)

            elif type=="liquidate":                
                resVolume1=TOKEN_PRICE_CENTER.swap(collateralAddress, timestamp_removeHour,purchaseAmount)
