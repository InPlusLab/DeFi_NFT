...
def X2Y2():    
    output_dict="/mnt/sde1/peilin_defi/data/volume_line/dict/timeWithVolume/X2Y2.map"    
    timeMap={}
    ...
    while (oneLine!=""):
        ...
        resVolume=TOKEN_PRICE_CENTER.swap(currency, timestamp_removeHour,itemPrice)        
